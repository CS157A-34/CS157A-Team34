              ...
              <form>
                <div className="form-row">
                  <div className="col-12 col-md-9 mb-2 mb-md-0">
                    <input className="form-control form-control-lg" type="search" placeholder="Search Stock Here..." />
                  </div>
                  <div className="col-12 col-md-3"><Link to="/search" className="btn btn-block btn-lg icon-search" type="search" /></div>
                </div>
              </form>
            </div>
